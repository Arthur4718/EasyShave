...
class AgendamentoAdapter(val userList : ArrayList<AgendamentoModel>) : RecyclerView.Adapter<AgendamentoAdapter.ViewHolder>()  {


    override fun onCreateViewHolder(viewGroup: ViewGroup, position: Int): AgendamentoAdapter.ViewHolder {

        val v = LayoutInflater.from(viewGroup.context).inflate(R.layout.agendamento_item, viewGroup, false)
        return ViewHolder(v)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val userCard : AgendamentoModel = userList[position]
